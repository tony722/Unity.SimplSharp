...
using HashHelpers = SSCore.Numerics.Hashing.HashHelpers;
...
namespace System
	...
	public struct ValueTuple : IEquatable<ValueTuple>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple>, IValueTupleInternal,
		...
		int IComparable.CompareTo (object other)
			...
			if (!(other is ValueTuple))
				throw new ArgumentException (String.Format ("Incorrect ValueTuple type: {0}", GetType ()), "other");
	...
	public struct ValueTuple<T1, T2> : IEquatable<ValueTuple<T1, T2>>, IStructuralEquatable, IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2>>,
		...
		public override int GetHashCode ()
			{
			return ValueTuple.CombineHashCodes (Item1 == null ? 0 : Item1.GetHashCode (), Item2 == null ? 0 : Item2.GetHashCode ());
			}
		...
		private int GetHashCodeCore (IEqualityComparer comparer)
			{
			return ValueTuple.CombineHashCodes (comparer.GetHashCode (Item1), comparer.GetHashCode (Item2)); // TODO-NULLABLE-GENERIC
			}
	...
	[Serializable]
	[StructLayout (LayoutKind.Auto)]
	public struct ValueTuple<T1, T2, T3> : IEquatable<ValueTuple<T1, T2, T3>>, IStructuralEquatable, IStructuralComparable, IComparable,
														IComparable<ValueTuple<T1, T2, T3>>, IValueTupleInternal, ITuple
		{
		/// <summary>
		...
		private int GetHashCodeCore (IEqualityComparer comparer)
			{
			return ValueTuple.CombineHashCodes (comparer.GetHashCode (Item1), comparer.GetHashCode (Item2), comparer.GetHashCode (Item3)); // TODO-NULLABLE-GENERIC
			}
	...
	[Serializable]
	[StructLayout (LayoutKind.Auto)]
	public struct ValueTuple<T1, T2, T3, T4> : IEquatable<ValueTuple<T1, T2, T3, T4>>, IStructuralEquatable, IStructuralComparable, IComparable,
															IComparable<ValueTuple<T1, T2, T3, T4>>, IValueTupleInternal, ITuple
		{
		/// <summary>
		...
		public override int GetHashCode ()
			{
			return ValueTuple.CombineHashCodes (Item1 == null ? 0 : Item1.GetHashCode (), Item2 == null ? 0 : Item2.GetHashCode (),
				Item3 == null ? 0 : Item3.GetHashCode (), Item4 == null ? 0 : Item4.GetHashCode ());
			}
	...
	[Serializable]
	[StructLayout (LayoutKind.Auto)]
	public struct ValueTuple<T1, T2, T3, T4, T5> : IEquatable<ValueTuple<T1, T2, T3, T4, T5>>, IStructuralEquatable, IStructuralComparable, IComparable,
																	IComparable<ValueTuple<T1, T2, T3, T4, T5>>, IValueTupleInternal, ITuple
		{
		/// <summary>
		...
		public override int GetHashCode ()
			{
			return ValueTuple.CombineHashCodes (Item1 == null ? 0 : Item1.GetHashCode (), Item2 == null ? 0 : Item2.GetHashCode (),
				Item3 == null ? 0 : Item3.GetHashCode (), Item4 == null ? 0 : Item4.GetHashCode (), Item5 == null ? 0 : Item5.GetHashCode ());
			}
	...
	[Serializable]
	[StructLayout (LayoutKind.Auto)]
	public struct ValueTuple<T1, T2, T3, T4, T5, T6> : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6>>, IStructuralEquatable, IStructuralComparable, IComparable,
																		IComparable<ValueTuple<T1, T2, T3, T4, T5, T6>>, IValueTupleInternal, ITuple
		{
		/// <summary>
		...
		private int GetHashCodeCore (IEqualityComparer comparer)
			{
			return ValueTuple.CombineHashCodes (comparer.GetHashCode (Item1), comparer.GetHashCode (Item2), comparer.GetHashCode (Item3), comparer.GetHashCode (Item4),
				comparer.GetHashCode (Item5), comparer.GetHashCode (Item6)); // TODO-NULLABLE-GENERIC
			}
	...
	[Serializable]
	[StructLayout (LayoutKind.Auto)]
	public struct ValueTuple<T1, T2, T3, T4, T5, T6, T7> : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>, IStructuralEquatable, IStructuralComparable,
																			IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6, T7>>, IValueTupleInternal, ITuple
		{
		/// <summary>
		...
		public override int GetHashCode ()
			...
			return ValueTuple.CombineHashCodes (Item1 == null ? 0 : Item1.GetHashCode (), Item2 == null ? 0 : Item2.GetHashCode (),
				Item3 == null ? 0 : Item3.GetHashCode (), Item4 == null ? 0 : Item4.GetHashCode (), Item5 == null ? 0 : Item5.GetHashCode (),
				Item6 == null ? 0 : Item6.GetHashCode (), Item7 == null ? 0 : Item7.GetHashCode ());
			}
		...
		private int GetHashCodeCore (IEqualityComparer comparer)
			{
			return ValueTuple.CombineHashCodes (comparer.GetHashCode (Item1), comparer.GetHashCode (Item2), comparer.GetHashCode (Item3), comparer.GetHashCode (Item4),
				comparer.GetHashCode (Item5), comparer.GetHashCode (Item6), comparer.GetHashCode (Item7)); // TODO-NULLABLE-GENERIC
			}
	...
	[Serializable]
	[StructLayout (LayoutKind.Auto)]
	public struct ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> : IEquatable<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>, IStructuralEquatable,
																						IStructuralComparable, IComparable, IComparable<ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>>, IValueTupleInternal, ITuple
		where TRest : struct
		{
		/// <summary>
		...
		public bool Equals (ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest> other)
			...
			return EqualityComparer<T1>.Default.Equals (Item1, other.Item1) && EqualityComparer<T2>.Default.Equals (Item2, other.Item2)
					&& EqualityComparer<T3>.Default.Equals (Item3, other.Item3) && EqualityComparer<T4>.Default.Equals (Item4, other.Item4)
					&& EqualityComparer<T5>.Default.Equals (Item5, other.Item5) && EqualityComparer<T6>.Default.Equals (Item6, other.Item6)
					&& EqualityComparer<T7>.Default.Equals (Item7, other.Item7) && EqualityComparer<TRest>.Default.Equals (Rest, other.Rest);
			}
		...
		public override int GetHashCode ()
			...
			switch (k)
				{
				case 1:
					return ValueTuple.CombineHashCodes (Item7 == null ? 0 : Item7.GetHashCode (), rest.GetHashCode ());
				case 2:
					return ValueTuple.CombineHashCodes (Item6 == null ? 0 : Item6.GetHashCode (), Item7 == null ? 0 : Item7.GetHashCode (), rest.GetHashCode ());
				case 3:
					return ValueTuple.CombineHashCodes (Item5 == null ? 0 : Item5.GetHashCode (), Item6 == null ? 0 : Item6.GetHashCode (),
						Item7 == null ? 0 : Item7.GetHashCode (), rest.GetHashCode ());
				case 4:
					return ValueTuple.CombineHashCodes (Item4 == null ? 0 : Item4.GetHashCode (), Item5 == null ? 0 : Item5.GetHashCode (),
						Item6 == null ? 0 : Item6.GetHashCode (), Item7 == null ? 0 : Item7.GetHashCode (), rest.GetHashCode ());
				case 5:
					return ValueTuple.CombineHashCodes (Item3 == null ? 0 : Item3.GetHashCode (), Item4 == null ? 0 : Item4.GetHashCode (),
						Item5 == null ? 0 : Item5.GetHashCode (), Item6 == null ? 0 : Item6.GetHashCode (), Item7 == null ? 0 : Item7.GetHashCode (), rest.GetHashCode ());
				case 6:
					return ValueTuple.CombineHashCodes (Item2 == null ? 0 : Item2.GetHashCode (), Item3 == null ? 0 : Item3.GetHashCode (),
						Item4 == null ? 0 : Item4.GetHashCode (), Item5 == null ? 0 : Item5.GetHashCode (), Item6 == null ? 0 : Item6.GetHashCode (),
						Item7 == null ? 0 : Item7.GetHashCode (), rest.GetHashCode ());
				case 7:
				case 8:
					return ValueTuple.CombineHashCodes (Item1 == null ? 0 : Item1.GetHashCode (), Item2 == null ? 0 : Item2.GetHashCode (),
			...
			switch (k)
				...
				case 3:
					return ValueTuple.CombineHashCodes (comparer.GetHashCode (Item5), comparer.GetHashCode (Item6), comparer.GetHashCode (Item7), rest.GetHashCode (comparer));
						// TODO-NULLABLE-GENERIC
				case 4:
					return ValueTuple.CombineHashCodes (comparer.GetHashCode (Item4), comparer.GetHashCode (Item5), comparer.GetHashCode (Item6), comparer.GetHashCode (Item7),
						rest.GetHashCode (comparer)); // TODO-NULLABLE-GENERIC
				case 5:
					return ValueTuple.CombineHashCodes (comparer.GetHashCode (Item3), comparer.GetHashCode (Item4), comparer.GetHashCode (Item5), comparer.GetHashCode (Item6),
						comparer.GetHashCode (Item7), rest.GetHashCode (comparer)); // TODO-NULLABLE-GENERIC
				case 6:
					return ValueTuple.CombineHashCodes (comparer.GetHashCode (Item2), comparer.GetHashCode (Item3), comparer.GetHashCode (Item4), comparer.GetHashCode (Item5),
						comparer.GetHashCode (Item6), comparer.GetHashCode (Item7), rest.GetHashCode (comparer)); // TODO-NULLABLE-GENERIC
				case 7:
				case 8:
					return ValueTuple.CombineHashCodes (comparer.GetHashCode (Item1), comparer.GetHashCode (Item2), comparer.GetHashCode (Item3), comparer.GetHashCode (Item4),
						comparer.GetHashCode (Item5), comparer.GetHashCode (Item6), comparer.GetHashCode (Item7), rest.GetHashCode (comparer)); // TODO-NULLABLE-GENERIC
				}
		...
		public override string ToString ()
			...
			IValueTupleInternal rest = Rest as IValueTupleInternal;
			if (rest == null)
				return "(" + Item1 + ", " + Item2 + ", " + Item3 + ", " + Item4 + ", " + Item5 + ", " + Item6 + ", " + Item7 + ", " + Rest.ToString () + ")";
			else
